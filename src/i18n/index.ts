...
const CATALOG: Record<string, { zh: string; en: string }> = {
  ...
  'settings.uiStyle': { zh: '界面风格', en: 'Shell style' },
  'settings.boardStyle': { zh: '棋盘风格', en: 'Board style' },
  'settings.cellStyle': { zh: '格子风格', en: 'Cell style' },
  'settings.styleHint': { zh: '三个面各自独立，可混搭。', en: 'Each surface is independent - mix freely.' },
  'style.flat': { zh: '简约', en: 'Flat' },
  'style.card': { zh: '卡片', en: 'Card' },
  'style.paper': { zh: '纸张', en: 'Paper' },
  'style.glass': { zh: '玻璃', en: 'Glass' },
  'style.mica': { zh: '云母', en: 'Mica' },
  'style.image': { zh: '自定义图片', en: 'Image' },
