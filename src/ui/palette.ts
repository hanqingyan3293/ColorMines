...
export const PALETTE: readonly Swatch[] = [
  ...
  { fill: '#d7a48e', ink: '#101418', zh: '丹砂', en: 'vermilion' },
  { fill: '#b96e31', ink: '#101418', zh: '绯红', en: 'scarlet' },
  { fill: '#d79d47', ink: '#101418', zh: '茜色', en: 'madder' },
  { fill: '#937a2f', ink: '#101418', zh: '赫赤', en: 'burnt red' },
  { fill: '#d7d08e', ink: '#101418', zh: '檀色', en: 'sandalwood' },
  { fill: '#b3b931', ink: '#101418', zh: '绛色', en: 'deep red' },
  { fill: '#bad747', ink: '#101418', zh: '赭石', en: 'ochre' },
  { fill: '#70932f', ink: '#101418', zh: '茶褐', en: 'tea brown' },
  { fill: '#b2d78e', ink: '#101418', zh: '琥珀', en: 'amber' },
  { fill: '#61b931', ink: '#101418', zh: '缃色', en: 'straw' },
  { fill: '#64d747', ink: '#101418', zh: '橘橙', en: 'orange' },
  { fill: '#34932f', ink: '#101418', zh: '杏色', en: 'apricot' },
  { fill: '#8ed795', ink: '#101418', zh: '柿色', en: 'persimmon' },
  { fill: '#31b953', ink: '#101418', zh: '珊瑚', en: 'coral' },
  { fill: '#47d780', ink: '#101418', zh: '蜜合', en: 'honey' },
  { fill: '#2f9366', ink: '#101418', zh: '藤黄', en: 'gamboge' },
  { fill: '#8ed7c1', ink: '#101418', zh: '栀子', en: 'gardenia' },
  { fill: '#31b9a5', ink: '#101418', zh: '鹅黄', en: 'goose yellow' },
